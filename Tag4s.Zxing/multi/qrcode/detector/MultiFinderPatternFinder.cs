...
using ResultPointCallback = Tag4s.Zxing.ResultPointCallback;
using Collections = Tag4s.Zxing.common.Collections;
using Comparator = Tag4s.Zxing.common.Comparator;
using BitMatrix = Tag4s.Zxing.common.BitMatrix;
using FinderPattern = Tag4s.Zxing.qrcode.detector.FinderPattern;
using FinderPatternFinder = Tag4s.Zxing.qrcode.detector.FinderPatternFinder;
