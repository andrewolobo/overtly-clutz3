...
using EncodeHintType = Tag4s.Zxing.EncodeHintType;
using ByteArray = Tag4s.Zxing.common.ByteArray;
using ByteMatrix = Tag4s.Zxing.common.ByteMatrix;
using CharacterSetECI = Tag4s.Zxing.common.CharacterSetECI;
using GF256 = Tag4s.Zxing.common.reedsolomon.GF256;
using ReedSolomonEncoder = Tag4s.Zxing.common.reedsolomon.ReedSolomonEncoder;
using ErrorCorrectionLevel = Tag4s.Zxing.qrcode.decoder.ErrorCorrectionLevel;
using Mode = Tag4s.Zxing.qrcode.decoder.Mode;
using Version = Tag4s.Zxing.qrcode.decoder.Version;
