...
using GridSampler = Tag4s.Zxing.common.GridSampler;
using MonochromeRectangleDetector = Tag4s.Zxing.common.detector.MonochromeRectangleDetector;
namespace Tag4s.Zxing.datamatrix.detector
{
